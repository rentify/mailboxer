module Mailboxer
  module Models
    module Messageable
      ...
      def reply_to_all(receipt, reply_body, subject=nil, sanitize_text=true, attachment=nil, recipients: nil)
        reply(receipt.conversation, recipients || receipt.message.recipients, reply_body, subject, sanitize_text, attachment)
      end
      ...
      def reply_to_conversation(conversation, reply_body, subject = nil, should_untrash = true, sanitize_text = true, attachment = nil, email_message_id = nil, recipients: nil)
        ...
        reply(conversation, recipients, reply_body, subject, sanitize_text, attachment, email_message_id)
      end
